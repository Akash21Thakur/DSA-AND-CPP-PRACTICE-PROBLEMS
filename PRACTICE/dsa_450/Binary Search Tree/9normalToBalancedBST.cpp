...
Node *buildBalancedTree(Node *root)
{
    vector<int> v; // stores sorted ordered element in inorder traversal of BST
    inOrder(root, v);
    // 	find mid_point of sorted element
    //  mid_point becomes root...left subtree...start to mid-1
